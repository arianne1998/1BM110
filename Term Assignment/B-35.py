...
# Read csv file and add columns with the daily max and total daily consumption
...
# Create boxplot for dwelling type vs daily max
plt.figure()
daily_max_dwelling_type = sns.boxplot(x = 'dwelling_type',y= 'daily_max',data = dataset)

# Create boxplot for dwelling type vs daily consumption
...
# Create boxplot for wall insulation vs daily consumption
plt.figure()
...
# Create boxplot for efficient lighting percentage vs daily consumption
plt.figure()
...
# Create scatter plot for average temperature vs daily consumption
plt.figure()
...
# Create scatter plot for minimum temperature vs daily consumption
plt.figure()
...
# Create scatter plot for maximum temperature vs daily consumption
plt.figure()
...
# Create scatter plot for average temperature vs daily 30 max
plt.figure()
avg_temp_daily_max = plt.scatter(dataset['avg temp'],dataset['daily_max'],s=1)
plt.savefig('Figures/temp_daily30max.png')

# Create scatter plot for the date vs average daily 30 max of all households per date
...
# Create scatter plot for the date vs average of all daily consumptions per date
...
# Create scatter plot for the date vs average of all temperatures per date
...
# Create scatter plot of normalized average consumption of all households vs temperatures
...
# Create scatter plot for average consupmtion of all households vs temperatures
